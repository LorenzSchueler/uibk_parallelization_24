...
int mpi_handler::get_rank() const { return rank; }

int mpi_handler::get_left() const { return left; }

int mpi_handler::get_right() const { return right; }

int mpi_handler::get_front() const { return front; }

int mpi_handler::get_back() const { return back; }

int mpi_handler::get_top() const { return top; }

int mpi_handler::get_bottom() const { return bottom; }

int mpi_handler::get_num_tasks(int dir) const { return num_tasks[dir]; }

int mpi_handler::get_coords(int dir) const { return coords[dir]; }

int mpi_handler::get_shift_cells(int dir) const { return shift_cells[dir]; }
